...
namespace ProjetoFinal.Controllers
{
    public class ProcedimentorealizadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,ProcedimentoId,ColaboradorId,LocalrealizacaoId,Datarealizacao,ObservacaoRealizacaoNome")] Procedimentorealizado procedimentorealizado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,ProcedimentoId,ColaboradorId,LocalrealizacaoId,Datarealizacao,ObservacaoRealizacaoNome")] Procedimentorealizado procedimentorealizado)
        {
